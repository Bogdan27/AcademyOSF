    ...
    public partial class UpdateCartRentScreen : Form
    {
        ...
        private void updateReservation()
        {
            try
            {
                ...
                {
                    string updateCustomer = "UPDATE Reservations set Plate=@Plate, CustomerId=@CustomerId, StartDate=@StartDate, EndDate=@EndDate, Location=@Location" +
                    ...
                    using (SqlCommand queryUpdateCustomer = new SqlCommand(updateCustomer))
                    {
                        ...
                        queryUpdateCustomer.Parameters.Add("@CustomerId", SqlDbType.Int).Value = Int32.Parse(textBoxClientID.Text);
